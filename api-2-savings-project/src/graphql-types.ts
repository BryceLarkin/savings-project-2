...
export type QueryProjectProfilesArgs = {
  where?: Maybe<QueryProjectProfilesWhereInput>,
  skip?: Maybe<Scalars['Int']>,
  after?: Maybe<Scalars['ID']>,
  before?: Maybe<Scalars['ID']>,
  first?: Maybe<Scalars['Int']>,
...
export type QueryProjectProfilesWhereInput = {
  project?: Maybe<ProjectWhereInput>,
};
...
export type UserProjectsArgs = {
  orderBy?: Maybe<UserProjectsOrderByInput>,
  skip?: Maybe<Scalars['Int']>,
  after?: Maybe<Scalars['ID']>,
  before?: Maybe<Scalars['ID']>,
  first?: Maybe<Scalars['Int']>,
