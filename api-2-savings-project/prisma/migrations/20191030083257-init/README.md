# Migration `20191030083257-init`

This migration has been generated by Nicholas Kang at 10/30/2019, 8:32:57 AM.
...
You can use a specific Photon built for this migration (20191030083257-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191030083257-init'
