# Migration `20191028080731-init`

This migration has been generated by Nicholas Kang at 10/28/2019, 8:07:31 AM.
...
You can use a specific Photon built for this migration (20191028080731-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191028080731-init'
