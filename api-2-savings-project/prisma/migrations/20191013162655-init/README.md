# Migration `20191013162655-init`

This migration has been generated by Nicholas Kang at 10/13/2019, 4:26:55 PM.
...
CREATE TABLE "lift"."Spend" (
  ...
  "forecastedSavings" INTEGER NOT NULL DEFAULT 0  ,
  "id" TEXT NOT NULL   ,
...
You can use a specific Photon built for this migration (20191013162655-init)
in your `before` or `after` migration script like this:

```ts
import Photon from '@generated/photon/20191013162655-init'
